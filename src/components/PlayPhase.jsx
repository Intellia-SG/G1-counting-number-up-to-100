...
const WORLDS = [
  { id: 0, name: 'Number Village', icon: '🏡', color: '#4caf50', desc: 'Numbers 0–10', difficulty: 1, count: 8 },
  { id: 1, name: 'Teen Town', icon: '🏔️', color: '#ff9800', desc: 'Numbers 11–40', difficulty: 2, count: 8 },
  { id: 2, name: 'Century City', icon: '🚀', color: '#e91e63', desc: 'Numbers 41–100', difficulty: 3, count: 8 },
];
...
export default function PlayPhase({ onComplete, audioEnabled }) {
  ...
  const handleAnswer = useCallback((isCorrect) => {
    ...
    if (isCorrect) {
      ...
      if (q.type === 'numeral_to_word' || q.type === 'word_to_numeral') setWordCorrect(w => w + 1);
      sounds.correct();
